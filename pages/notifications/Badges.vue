  ...
  <div class="wrapper">
    <div class="animated fadeIn">
      <b-row>
        ...
        <b-col cols="12" md="6">
          <b-card
            header="<i class='fa fa-align-justify'></i> Badge <small>contextual variations</small>"
            header-tag="header"
            footer-tag="footer"
          >
            <div>
          ...
          <b-card
            header="<i class='fa fa-align-justify'></i> Badge <small>pills</small>"
            header-tag="header"
            footer-tag="footer"
          >
            <div>
          ...
          <b-card
            header="<i class='fa fa-align-justify'></i> Badge <small>actionable</small>"
            header-tag="header"
            footer-tag="footer"
          >
            <div>
