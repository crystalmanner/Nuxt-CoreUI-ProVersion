    ...
    <b-row>
      ...
      <b-col xs="12" lg="6">
        <b-card>
          ...
          <b-tabs v-model="tabIndex[0]">
            <b-tab active>
              <template slot="title">
                <i class="icon-calculator" /> {{ tabs[0] }}
              </template>
              <br> 1. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
              et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
              aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
            ...
            <b-tab>
              <template slot="title">
                <i class="icon-basket-loaded" /> {{ tabs[1] }}
              </template>
              <br>2. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
              et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
              aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
      ...
      <b-col xs="12" lg="6">
        <b-card>
          ...
          <b-card no-body>
            <b-tabs v-model="tabIndex[1]" card pills vertical nav-wrapper-class="w-40">
              <b-tab active>
                <template slot="title">
                  <i class="icon-calculator" /> {{ tabs[0] }}
                </template>
