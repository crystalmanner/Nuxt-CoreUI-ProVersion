  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col sm="6">
        <b-card>
          <div slot="header">
            <strong>Masked Input</strong> <small class="ml-1">
              vue-text-mask
            </small>
      ...
      <b-col sm="6">
        <b-card>
          <div slot="header">
            <strong>Multiselect</strong> <small class="ml-1">
              vue-multiselect
            </small>
            <a href="https://coreui.io/pro/vue/" rel="noreferrer noopener" target="_blank" class="badge badge-danger ml-1">
              CoreUI Pro
          ...
          <div>
            <multiselect v-model="multi" :options="options" :multiple="true" label="label" track-by="label" />
          </div>
        </b-card>
        <b-card>
          <div slot="header">
            <strong>Select</strong> <small class="ml-1">
              vue-select
            </small>
            <a href="https://coreui.io/pro/vue/" rel="noreferrer noopener" target="_blank" class="badge badge-danger ml-1">
              CoreUI Pro
          ...
          <div>
            <v-select v-model="selected" multiple :options="options" placeholder="Select option" />
          </div>
        </b-card>
        <b-card>
          <div slot="header">
