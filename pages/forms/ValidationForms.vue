<template>
  <div class="animated fadeIn">
    <b-card no-body>
      <b-card-header>
        <i class="icon-note" /> Form Validation
      ...
      <b-card-body>
        <b-link href="https://monterail.github.io/vuelidate" target="_blank" rel="noreferrer noopener">
          Vuelidate
        </b-link> provides <cite>Simple, lightweight model-based validation for Vue.js</cite>
        <hr>
        <b-row>
          <b-col lg="6">
            <!--<h6>Simple Form</h6>-->
            <b-form novalidate @submit.prevent="onSubmit" @reset.prevent="onReset">
              ...
              <b-button class="ml-1" type="reset" variant="danger" :disabled="!isDirty">
                Reset
              </b-button>
            </b-form>
            <br>
