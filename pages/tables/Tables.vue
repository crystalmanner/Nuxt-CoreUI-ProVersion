<template>
  <div class="animated fadeIn">
    <b-row>
      <b-col lg="6">
        <c-table :table-data="items" :fields="fields" caption="<i class='fa fa-align-justify'></i> Simple Table" />
      </b-col>

      <b-col lg="6">
        <c-table :table-data="items" striped caption="<i class='fa fa-align-justify'></i> Striped Table" />
      </b-col>
    </b-row><!--/.row-->

    <b-row>
      <b-col lg="6">
        <c-table :table-data="items" small caption="<i class='fa fa-align-justify'></i> Condensed Table" />
      </b-col>

      <b-col lg="6">
        <c-table :table-data="items" fixed bordered caption="<i class='fa fa-align-justify'></i> Bordered Table" />
      </b-col>
    </b-row>
