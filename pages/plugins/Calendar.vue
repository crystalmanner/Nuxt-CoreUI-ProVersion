<template>
  <b-card no-body>
    <div slot="header">
      <i class="cui-calendar mr-1" /> Calendar
    ...
    <b-card-footer>
      <b-form inline>
        <label class="mr-2 my-auto" for="selectedView">
          View
        </label>
        <b-form-group class="my-auto">
          <b-form-select id="selectedView" v-model="displayPeriod" :plain="true" name="selectedView">
            <option value="month">
              month
            </option>
            <option value="week">
        ...
        <h4 class="ml-auto my-auto">
          <b-badge v-if="message" variant="primary">
            {{ message }}
          </b-badge>
        </h4>
      </b-form>
