<template>
  <AppHeaderDropdown right no-caret>
    <template slot="header">
      <i class="icon-list" /><b-badge pill variant="warning">
        {{ itemsCount }}
      </b-badge>
    </template>
    <template slot="dropdown">
      ...
      <b-dropdown-item>
        <div class="small mb-1">
          Upgrade NPM &amp; Bower <span class="float-right">
            <strong>0%</strong>
          </span>
        </div>
      ...
      <b-dropdown-item>
        <div class="small mb-1">
          ReactJS Version <span class="float-right">
            <strong>25%</strong>
          </span>
        </div>
      ...
      <b-dropdown-item>
        <div class="small mb-1">
          VueJS Version <span class="float-right">
            <strong>50%</strong>
          </span>
        </div>
      ...
      <b-dropdown-item>
        <div class="small mb-1">
          Add new layouts <span class="float-right">
            <strong>75%</strong>
          </span>
        </div>
      ...
      <b-dropdown-item>
        <div class="small mb-1">
          Angular 2 Cli Version <span class="float-right">
            <strong>100%</strong>
          </span>
        </div>
